...
import org.datasource.mongodb.views.products.ProductViewBuilder;
import java.util.logging.Logger;


/*	REST Service URL
	http://localhost:8093/DSA-NoSQL-MongoDBService/rest/locations/ProductView
...
public class RESTViewServiceMongoDB {
	...
	@RequestMapping(value = "/ProductView", method = RequestMethod.GET,
			produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
	@ResponseBody
	public List<ProductView> get_ProductView() throws Exception {
